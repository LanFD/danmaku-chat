/*!
 * Danmaku - HTML5 Danmaku Engine v2.3.0
 * https://github.com/jamesliu96/Danmaku
 *
...
;(window => {
    ...
    function _preload(d, f) {
        var cvs = Danmaku.dom.createElement('canvas'),
    ...
    class Canvas {
        constructor(m, n, r, t) {
            ...
            this.parent = m.nodeType == 1 ? m : Danmaku.dom.getElementById(m);
            this.id = n;
            this.rows = r;
            ...
            this.layer = Danmaku.dom.createElement('canvas');
    ...
    Danmaku.version = 'v2.3.0';

    Danmaku.dom = window.document;
